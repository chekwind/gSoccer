...
QUALITY_COLOR={0:'000000',1:'6fca26',2:'2b50de',3:'c526ca',4:'f5b300',5:'ef7700',6:'e02a0f',7:'ee115c'}#品质对应的色值
...
class ItemBaseInfoComponent(BaseInfoComponent):
	...
	def getItemTemplateInfo(self):
		...
		if self.itemTemplateId!=-1 and self.itemTemplateId!=0:
			self._baseName=dbItems.all_ItemTemplate[self.itemTemplateId]['ItemName']
	...
	def getLevelRequired(self):
		'''获取等级需求'''
		return self.getItemTemplateInfo().get("levelRequired",1)
